...
<html lang="en">
	<head>
		...
		<script src="../script/template_description.js"></script>
			...
			<div class="container">
				...
				<div class="container">
					<div id="template_description">
						...
						<form>
							<?php
							$sql_statement = "SELECT DescriptionID as id, Content as content FROM template_description WHERE TemplateID = $id";
							$result = mysqli_query($conn, $sql_statement);
							...
							?>
								<div class="form-group">
									...
									<div class="col-xs-8">
										<input type="text" value="<?php echo $d_content; ?>" att-id="<?php echo $d_id; ?>" class="form-control inp-des" placeholder="Description"/>
									</div>
									<div class="col-xs-2">
										<input type="button" value="Delete" att-id="<?php echo $d_id; ?>" class="btn btn-danger" onclick="deleteButtionFunc(this)"/>
									</div>
							...
							<div class="form-group">
								<div class="col-xs-1"></div>
								<div class="col-xs-8">
									<input type="text" value="" id="btn-add-des" class="form-control" placeholder="Description"/>
								</div>
								<div class="col-xs-2">
